...
from isaaclab.utils.math import sample_uniform, quat_conjugate, quat_mul, quat_apply, quat_from_euler_xyz
...
class GraspingDualRobotV0(DirectRLEnv):
    ...
    def __init__(self, cfg: GraspingDualRobot, render_mode: str | None = None, **kwargs):
        ...
        print("[DEBUG] Available body names for gripper:", self._robot_grip.body_names)
        print("[DEBUG] Available joint names for gripper:", self._robot_grip.joint_names)
        self._ee_index_grip = self._robot_grip.body_names.index("base_link_0")
        print("[DEBUG] Available body names for screwdriver:", self._robot_screw.body_names)
        print("[DEBUG] Available joint names for screwdriver:", self._robot_screw.joint_names)
    ...
    def _setup_scene(self):
        ...
        self.wooden_block = RigidObject(self.cfg.wooden_block)
    ...
    def _reset_idx(self, env_ids: torch.Tensor):
        ...
        # spawn wooden block at with randomness
        ...
        self.wooden_block.write_root_pose_to_sim(pose)
