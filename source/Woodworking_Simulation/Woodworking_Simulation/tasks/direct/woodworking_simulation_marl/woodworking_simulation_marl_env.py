...
from .woodworking_simulation_marl_env_cfg import WoodworkingSimulationMarlEnvCfg


class WoodworkingSimulationMarlEnv(DirectMARLEnv):
    cfg: WoodworkingSimulationMarlEnvCfg

    def __init__(self, cfg: WoodworkingSimulationMarlEnvCfg, render_mode: str | None = None, **kwargs):
