...
@configclass
class Ur10tutoSceneCfg(InteractiveSceneCfg):
    """Configuration for a UR10 robot scene."""
...
@configclass
class Ur10tutoEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the reach end-effector pose tracking environment."""

    # Scene settings - how many robots, how far apart?
    scene = Ur10tutoSceneCfg(num_envs=2000, env_spacing=2.5)
    # Basic settings
...
@configclass
class Ur10tutoEnvCfg_PLAY(Ur10tutoEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
