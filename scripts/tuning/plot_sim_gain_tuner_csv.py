...
Usage:
    python3 scripts/tuning/plot_sim_gain_tuner_csv.py --file logs/sim_gain_tuner/run.csv
    python3 scripts/tuning/plot_sim_gain_tuner_csv.py --file sim.csv --file-real real.csv
"""
